    ...
    */
    ...
    void send_onlooker_bees() {
        ...
        for (int i = 0; i < num_bees; ++i) {
            ...
            //#pragma omp parallel for reduction(+ : accum_prob)
...
//Here the main optimization occurs by interating throught the whole process max_trials times.
    Bee optimize() {
        ...
        #pragma omp parallel for // shared(best_solution,population)
...
int main(int argc, char* argv[]) {
    ...
    cout<<"Total number of threads available is: "<<omp_get_max_threads()<<endl;
    return 0;
}
